...
class TestExtractPrimaryPort:
    ...
    def test_extract_primary_port_standard(
        self, mock_container_handler: DockerContainerHandler, ports: dict, expected: str | None
    ) -> None:
...
class TestCheckDockerAvailable:
    ...
    def test_docker_available(self, mock_container_handler: DockerContainerHandler) -> None:
...
class TestListContainers:
    ...
    def test_list_containers(self, mock_container_handler: DockerContainerHandler, mock_container: MagicMock) -> None:
...
class TestStartContainer:
    ...
    def test_start_container(self, mock_container_handler: DockerContainerHandler, mock_container: MagicMock) -> None:
...
class TestStopContainer:
    ...
    def test_stop_container(self, mock_container_handler: DockerContainerHandler, mock_container: MagicMock) -> None:
...
class TestRestartContainer:
    ...
    def test_restart_container(self, mock_container_handler: DockerContainerHandler, mock_container: MagicMock) -> None:
...
class TestUpdateContainer:
    ...
    def test_update_container_success(
        self, mock_container_handler: DockerContainerHandler, mock_container: MagicMock
    ) -> None:
